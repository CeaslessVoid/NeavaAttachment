...
//                else
//                {
//                    DrawModBoxContents(modRect, effectDef);
//                }
...
//            {
//                Vector2 size = new Vector2(ModBoxWidth, ModBoxHeight);
//                Vector2 pos = Event.current.mousePosition;

//                Rect dragRect = new Rect(pos.x - size.x / 2, pos.y - size.y / 2, size.x, size.y);
//                DrawModBoxContents(dragRect, def, 0.8f);
//            }
//        }


//        private void DrawModBoxContents(Rect modRect, ModEffectDef effectDef, float opacity = 1f, float imageScale = 0.5f)
//        {
//            Widgets.DrawBoxSolid(modRect, new Color(0.3f, 0.3f, 0.3f, 0.6f * opacity));

//            if (effectDef.Image != null && effectDef.Image != BaseContent.BadTex)
//            {
//                Vector2 originalSize = new Vector2(effectDef.Image.width, effectDef.Image.height);
//                Vector2 scaledSize = originalSize * imageScale;
//                Vector2 center = modRect.center;

//                Rect imageRect = new Rect(
//                    center.x - scaledSize.x / 2f,
//                    center.y - scaledSize.y / 2f,
//                    scaledSize.x,
//                    scaledSize.y
//                );

//                GUI.color = new Color(1f, 1f, 1f, 0.5f * opacity);
//                GUI.DrawTexture(imageRect, effectDef.Image);
